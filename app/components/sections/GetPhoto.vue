...
<template>
  <section class="bg-white py-16 lg:py-20">
    <div class="mx-auto max-w-[1280px] space-y-20 px-5 lg:space-y-32 lg:px-8">
      <article id="park" class="reveal grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
        <div class="order-2 lg:order-1">
          <div class="mb-5 flex items-center gap-3">
            <div class="svc-chip chip-park">P</div>
            <div>
          ...
          <h3 class="font-display text-3xl font-bold leading-tight md:text-4xl">
            Найди свои фото из&nbsp;парка <span class="grad-text">по одному селфи</span>
          </h3>
          <p class="mt-4 text-lg leading-relaxed text-ink-700">
            Наши фотоловушки снимают вас на аттракционах, у героев и в самых ярких моментах. Загрузите селфи — система за секунды найдёт все ваши кадры за день.
          </p>
          <ul class="mt-6 space-y-2.5 text-ink-700">
            <li class="flex gap-2.5"><span class="font-bold text-cyan">✓</span> Сотни кадров за день — без поиска по очереди</li>
            <li class="flex gap-2.5"><span class="font-bold text-cyan">✓</span> Замена фона на любой пейзаж</li>
            <li class="flex gap-2.5"><span class="font-bold text-cyan">✓</span> Скачивание в HD, печать, отправка близким</li>
          </ul>
          <div class="mt-8 flex flex-wrap gap-3">
            <a href="https://park.super.photo" class="btn-primary">Найти свои фото</a>
            <a href="https://park.super.photo" class="btn-secondary">Подробнее →</a>
          </div>
        </div>
        <div class="order-1 rounded-2xl grad-card-park p-5 lg:order-2 lg:p-8">
          <div class="relative aspect-[4/3] overflow-hidden rounded-xl bg-ink-100 shadow-card">
            <img src="@/assets/hero-family.png" alt="Семья в парке развлечений" class="h-full w-full object-cover" width="800" height="600" />
      ...
      <article id="ai" class="reveal grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
        <div class="rounded-2xl grad-card-ai p-5 lg:p-8">
          <WidgetBeforeAfterSlider />
        </div>
        <div>
          <div class="mb-5 flex items-center gap-3">
            <div class="svc-chip chip-ai">A</div>
            <div>
              <div class="text-lg font-extrabold">AI<span class="font-medium text-ink-500">.super.photo</span></div>
            </div>
          </div>
          <h3 class="font-display text-3xl font-bold leading-tight md:text-4xl">
            Освежи лицо и фигуру <span class="grad-text">за 10 секунд</span>
          </h3>
          <p class="mt-4 text-lg leading-relaxed text-ink-700">
            Простой редактор без сложных настроек. Нажми одну кнопку — нейросеть уберёт усталость, освежит кожу, поправит причёску.
          </p>
          ...
          <div class="mt-8 flex flex-wrap gap-3">
            <a href="https://ai.super.photo" class="btn-primary">Попробовать бесплатно</a>
            <a href="https://ai.super.photo" class="btn-secondary">Все функции →</a>
          </div>
        </div>
      </article>

      <article id="print" class="reveal grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
        <div class="order-2 lg:order-1">
          <div class="mb-5 flex items-center gap-3">
            <div class="svc-chip chip-print">R</div>
            <div>
              <div class="text-lg font-extrabold">Print<span class="font-medium text-ink-500">.super.photo</span></div>
            </div>
          </div>
          <h3 class="font-display text-3xl font-bold leading-tight md:text-4xl">
            Распечатаем фото и фотокниги, <span class="grad-text">привезём СДЭК</span>
          </h3>
          <p class="mt-4 text-lg leading-relaxed text-ink-700">
            AI сам соберёт макет фотокниги из ваших снимков. Печатаем на профессиональной бумаге Fuji, доставка до пункта выдачи за 1–2 дня.
          </p>
          ...
          <div class="mt-8 flex flex-wrap gap-3">
            <a href="https://print.super.photo" class="btn-primary">Создать фотокнигу</a>
            <a href="https://print.super.photo" class="btn-secondary">Каталог →</a>
          </div>
        </div>
        <div class="order-1 rounded-2xl grad-card-print p-5 lg:order-2 lg:p-8">
          <div class="aspect-[4/3] overflow-hidden rounded-xl bg-ink-100 shadow-card">
            <img src="@/assets/print-album.png" alt="Фотокнига с семейными фото" class="h-full w-full object-cover" width="800" height="600" />
          </div>
        </div>
      </article>
      ...
      <article id="star" class="reveal grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
        <div class="rounded-2xl grad-card-star p-5 lg:p-8">
          <div class="relative aspect-[4/3] overflow-hidden rounded-xl bg-ink-100 shadow-card">
            <img src="@/assets/star-fan.png" alt="Фото со звездой" class="h-full w-full object-cover" width="800" height="600" />
            <div class="absolute left-4 top-4 rounded-full bg-navy/85 px-3 py-1.5 text-xs font-bold uppercase tracking-wider text-white backdrop-blur">
              ✨ AI-generated
            </div>
          </div>
        </div>
        <div>
          <div class="mb-5 flex items-center gap-3">
            <div class="svc-chip chip-star">S</div>
            <div>
              <div class="text-lg font-extrabold">Star<span class="font-medium text-ink-500">.super.photo</span></div>
            </div>
          </div>
          <h3 class="font-display text-3xl font-bold leading-tight md:text-4xl">
            Сделай кадр <span class="grad-text">со своим кумиром</span>
          </h3>
          <p class="mt-4 text-lg leading-relaxed text-ink-700">
            Концерты, кулисы, бытовые сценки — нейросеть собирает фотореалистичные кадры с любимой звездой. Каждый сценарий согласован лично с артистом.
          </p>
          ...
          <div class="mt-8 flex flex-wrap gap-3">
            ...
            >Открыть демо</a
            >
            <a href="https://star.super.photo" class="btn-secondary">Как это работает →</a>
          </div>
        </div>
      </article>
    </div>
